...
typedef Dialog::Templ<ParametersBase, ComPortTable> TComPortDlg;
...
//		VL::find<baud_rate_list, __get_param__>()(data);
//		return data.id;
//	}
//};

template<>struct __data_from_widget__<Dialog::DlgItem2<BaudRate, TComPortDlg>, int>
{
	int operator()(Dialog::DlgItem2<BaudRate, TComPortDlg>& o)
	{
		__data__<baud_rate_list> data;
...
//	}
//};
template<>struct __data_from_widget__<Dialog::DlgItem2<Parity, TComPortDlg>, int>
{
	int operator()(Dialog::DlgItem2<Parity, TComPortDlg>& o)
	{
		__data__<baud_parity_list> data;
		data.id = ComboBox_GetCurSel(o.hWnd);
...
//	}
//};
template<>struct __data_from_widget__<Dialog::DlgItem2<StopBits, TComPortDlg>, int>
{
	int operator()(Dialog::DlgItem2<Parity, TComPortDlg>& o)
	{
		__data__<baud_stop_bits_list> data;
