...
//<BeginErrorDescription>
  ...
  rshUTF16("PLX API - неверная информация об устройстве"),
  ...
  rshUTF16("PLX API - неверный канал ПДП."),
